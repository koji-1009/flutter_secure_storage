...
public class FlutterSecureStoragePlugin: NSObject, FlutterPlugin {
  ...
  private let serialQueue = DispatchQueue(
    label: "plugins.koji-1009.com/flutter_secure_storage_queue"
  )

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(
      name: "plugins.koji-1009.com/flutter_secure_storage",
  ...
  private func read(
    ...
    let response = flutterSecureStorageManager.read(
      ...
      useDataProtectionKeyChain: values.useDataProtectionKeyChain
    )
  ...
  private func write(
    ...
    if values.value == nil {
      result(
        FlutterError.init(
          code: "Missing Parameter",
          message: "write requires value parameter",
          details: nil
        )
      )
      return
  ...
  private func delete(
    ...
    if values.key == nil {
      result(
        FlutterError.init(
          code: "Missing Parameter",
          message: "delete requires key parameter",
          details: nil
        )
      )
      return
  ...
  private func parseCall(_ call: FlutterMethodCall)
    -> FlutterSecureStorageRequest
  {
    ...
    let useDataProtectionKeyChainString =
      options["useDataProtectionKeyChain"] as? String

    let synchronizable: Bool =
      synchronizableString != nil ? Bool(synchronizableString!)! : false
    let useDataProtectionKeyChain: Bool =
      useDataProtectionKeyChainString != nil
      ? Bool(useDataProtectionKeyChainString!)! : true
  ...
  private func handleResponse(
    _ response: FlutterSecureStorageResponse,
    _ result: @escaping FlutterResult
  ) {
