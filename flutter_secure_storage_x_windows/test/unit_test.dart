...
import 'package:flutter_secure_storage_x_windows/src/flutter_secure_storage_windows_ffi.dart'
    as ffi;
import 'package:flutter_secure_storage_x_windows/src/flutter_secure_storage_windows_ffi.dart';
import 'package:flutter_secure_storage_x_windows/src/flutter_secure_storage_windows_stub.dart'
    as stub;
...
void main() {
  ...
  group('Stub does not work at all', () {
    test('constructor', () async {
      expect(() => stub.FlutterSecureStorageWindows(), throwsAssertionError);
    });
  });
